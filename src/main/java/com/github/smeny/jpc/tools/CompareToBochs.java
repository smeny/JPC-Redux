...
public class CompareToBochs {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class c1 = cl1.loadClass("com.github.smeny.jpc.emulator.PC");
        ...
        while (true) {
            ...
            if (followBochsInts) {
                ...
                // bochs does an extra instruction after an int, which can end up more than byte further into the int handler
                {
                    ...
                    {
                        pitExpiry1.invoke(newpc, (long) (bochsState[16] - 10));
                        // triggger PIT irq lower
                        ints1.invoke(newpc, 0, Boolean.FALSE);
                    }
                    pitExpiry1.invoke(newpc, (long) (bochsState[16] - 10));
            ...
            try {
                ...
                boolean jpcInInt = (Boolean) ints1.invoke(newpc, 1, bochsEnteredPitInt);
                ...
                if ((!jpcInInt && bochsEnteredPitInt) && !previousInstruction().contains("hlt")) {
                    ...
                    pitExpiry1.invoke(newpc, (long) (bochsState[16] - 10));
                    jpcInInt = (Boolean) ints1.invoke(newpc, 1, bochsEnteredPitInt);
                }
            ...
            try {
                line = instructionInfo.invoke(newpc, 1) + " == " + nextBochs; // instructions per block
            } catch (Exception e) {
...
//                dirtyPages.add(0x1f8);
            ...
            for (int i : dirtyPages) {
                Integer l1 = (Integer) save1.invoke(newpc, i << 12, sdata1);
                ...
                if ((l2 > 0) && (l1 > 0)) {
                    ...
                    if (!samePage(i, sdata1, sdata2, addrs)) {
                        if (missedIntDuringRep && (i == (bochsState[32] + bochsState[4]) >> 12)) {
                            load1.invoke(newpc, i << 12, sdata2, false);
