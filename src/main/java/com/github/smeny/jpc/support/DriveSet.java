...
public class DriveSet extends AbstractHardwareComponent
{
    ...
    private static enum Devices {
        DEFAULT("com.github.smeny.jpc.support.FileBackedSeekableIODevice"),
        
        dir("com.github.smeny.jpc.support.TreeBlockDevice"),
        mem("com.github.smeny.jpc.support.ArrayBackedSeekableIODevice"),
        net("com.github.smeny.jpc.support.RemoteSeekableIODevice");
