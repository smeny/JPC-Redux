...
public class setle_Eb_mem extends Executable
{
    final Pointer op1;

    public setle_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set8(cpu, (byte)((cpu.zf() || (cpu.sf() != cpu.of())) ? 1 : 0));
        return Branch.None;
    }
