/*
    ...
    Copyright (C) 2019 Stephane Meny
    ...
    Details of the original project (including contact information) can be found at:
    https://sourceforge.net/projects/jpc/
...
public class Disassembler {
  ...
  public static String getExecutableName(int mode, Instruction in) {
    ...
    switch (mode) {
      case 1:
        instructions = rm_instructions;
        prefix = "com.github.smeny.jpc.emulator.execution.opcodes.rm.";
        break;
      case 2:
        instructions = pm_instructions;
        prefix = "com.github.smeny.jpc.emulator.execution.opcodes.pm.";
        break;
      case 3:
        instructions = vm_instructions;
        prefix = "com.github.smeny.jpc.emulator.execution.opcodes.vm.";
        break;
      default:
        throw new IllegalStateException("Unknown mode: " + mode);
    }
  ...
  public static class ByteArrayPeekStream implements PeekableInputStream {
    ...
    public long readU32() {
      return (data[index++] & 0xFF) | ((data[index++] & 0xFF) << 8) | ((data[index++] & 0xFF) << 16) |
          ((data[index++] & 0xFF) << 24);
    }
  ...
  public static void disasm_operands(int mode, PeekableInputStream input, Instruction inst) {
    ...
    if (mopt[2] != OP_NONE) {
      inst.operand =
          new Instruction.Operand[]{new Instruction.Operand(), new Instruction.Operand(), new Instruction.Operand()};
  ...
  private static void decode_modrm(int mode, Instruction inst, PeekableInputStream input, Instruction.Operand op, int s,
                                   String rm_type, Instruction.Operand opreg, int reg_size, String reg_type) {
