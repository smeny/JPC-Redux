...
public class inc_o16_eCX extends Executable
{

    public inc_o16_eCX(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        cpu.flagOp1 = (short)cpu.r_ecx.get16();
        cpu.flagOp2 = 1;
