...
public class fidivr_Mq_mem extends Executable
{
    final Pointer op1;

    public fidivr_Mq_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        double freg1 = (double)op1.get64(cpu);
