...
public class bsr_Gd_Ed_mem extends Executable
{
    final int op1Index;
    final Pointer op2;

    public bsr_Gd_Ed_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
	    ...
	    cpu.zf(false);
	    op1.set32(31-StaticOpcodes.numberOfLeadingZeros(op2.get32(cpu)));
	}
        return Branch.None;
    }
