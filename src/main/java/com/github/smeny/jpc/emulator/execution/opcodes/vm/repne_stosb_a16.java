...
public class repne_stosb_a16 extends Executable
{

    public repne_stosb_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.rep_stosb_a16(cpu);
        return Branch.None;
    }
