...
public class fldlg2 extends Executable
{

    public fldlg2(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.push(Math.log(2.0)/Math.log(10.0));
        return Branch.None;
    }
