...
import com.github.smeny.jpc.emulator.execution.decoder.Prefices;
import com.github.smeny.jpc.emulator.processor.Processor;
import com.github.smeny.jpc.emulator.processor.Segment;

public class lodsd_a32 extends Executable {
  final int segIndex;

  public lodsd_a32(int blockStart, int eip, int prefices, PeekableInputStream input) {
  ...
  public Branch execute(Processor cpu) {
    ...
    StaticOpcodes.lodsd_a32(cpu, seg);
    return Branch.None;
  }
