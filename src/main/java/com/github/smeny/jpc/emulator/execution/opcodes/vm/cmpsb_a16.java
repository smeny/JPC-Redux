...
public class cmpsb_a16 extends Executable
{
    final int segIndex;

    public cmpsb_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.cmpsb_a16(cpu, seg);
        return Branch.None;
    }
