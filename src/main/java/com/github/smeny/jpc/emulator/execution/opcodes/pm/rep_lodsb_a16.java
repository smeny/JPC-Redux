...
public class rep_lodsb_a16 extends Executable
{
    final int segIndex;

    public rep_lodsb_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.rep_lodsb_a16(cpu, seg);
        return Branch.None;
    }
