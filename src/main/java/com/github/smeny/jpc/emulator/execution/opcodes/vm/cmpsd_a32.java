...
public class cmpsd_a32 extends Executable
{
    final int segIndex;

    public cmpsd_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.cmpsd_a32(cpu, seg);
        return Branch.None;
    }
