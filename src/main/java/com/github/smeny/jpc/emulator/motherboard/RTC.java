...
import com.github.smeny.jpc.emulator.peripheral.FloppyController;
...
public class RTC extends AbstractHardwareComponent implements IODevice {
   ...
   */
  public RTC(int ioPort, int irq, int systemRamSize, Calendar startTime) {
  ...
  private void init() {
    ...
    if (systemRamSize > (16 * 1024 * 1024))
      val = (systemRamSize / 65536) - ((16 * 1024 * 1024) / 65536);
    else
      val = 0;
    if (val > 65535) val = 65535;
