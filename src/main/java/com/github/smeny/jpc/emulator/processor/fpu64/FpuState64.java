...
package com.github.smeny.jpc.emulator.processor.fpu64;
...
public class FpuState64 extends FpuState {
  ...
  public static final double DEFAULT_NAN = -1.5;
      // Double.longBitsToDouble(0xFFF8000000000000L);// to match Bochs' floatx80_default_nan truncation
  ...
  public void prepareFPU(Processor cpu, boolean checkExceptions) {
    if (((cpu.getCR0() & Processor.CR0_FPU_EMULATION) != 0) || (((cpu.getCR0() & Processor.CR0_MONITOR_COPROCESSOR) != 0) &&
        ((cpu.getCR0() & Processor.CR0_TASK_SWITCHED) != 0))) {
