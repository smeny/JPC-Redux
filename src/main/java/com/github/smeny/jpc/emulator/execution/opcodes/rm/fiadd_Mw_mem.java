...
public class fiadd_Mw_mem extends Executable
{
    final Pointer op1;

    public fiadd_Mw_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.setST(0, cpu.fpu.ST(0)+op1.get16(cpu));
        return Branch.None;
    }
