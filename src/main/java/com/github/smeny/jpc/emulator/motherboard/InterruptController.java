...
public class InterruptController extends AbstractHardwareComponent implements IODevice {
  ...
  /**
   * Constructs a <code>InterruptController</code> which will attach itself to a <code>Processor</code> instance during
  ...
  /**
   * Return the highest priority interrupt request currently awaiting service on this interrupt controller.  This is
   * called by the processor emulation once its <code>raiseInterrupt</code> method has been called, to get the correct
