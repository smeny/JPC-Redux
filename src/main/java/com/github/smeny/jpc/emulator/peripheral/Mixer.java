package com.github.smeny.jpc.emulator.peripheral;
    ...
    public static class MixerChannel {
        ...
        public void AddSamples(/*Bitu*/int len, Ptr data, boolean stereo, boolean signeddata, boolean nativeorder) {
            ...
            for (; ; ) {
                ...
                /*Bits*/
                int diff_mul = freq_index & MIXER_REMAIN;
                freq_index += freq_add;
...
//        }
        ...
        public void AddStretched(/*Bitu*/int len, /*Bit16s*/short[] data) {
            ...
            /*Bitu*/
            int outlen = needed - done;/*Bits*/
            int diff;
            freq_index = 0;
            /*Bitu*/
            int temp_add = (len << MIXER_SHIFT) / outlen;
            /*Bitu*/
            int mixpos = mixer.pos + done;
            done = needed;
            /*Bitu*/
    ...
    static boolean MIXER_CallBack(byte[] stream, int len) {
        /*Bitu*/
        int need = (/*Bitu*/int) len / MIXER_SSIZE;
        /*Bit16s*/
        ShortPtr output = new ShortPtr(stream, 0);
        /*Bitu*/
        int reduce;
        /*Bitu*/
        int pos, index, index_add;
        /*Bits*/
        int sample;
