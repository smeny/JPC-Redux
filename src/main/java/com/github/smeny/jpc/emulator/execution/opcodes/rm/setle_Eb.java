...
public class setle_Eb extends Executable
{
    final int op1Index;

    public setle_Eb(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        op1.set8((byte)((cpu.zf() || (cpu.sf() != cpu.of())) ? 1 : 0));
        return Branch.None;
    }
