...
public class xor_Ed_Ib_mem extends Executable
{
    final Pointer op1;
    final int immb;

    public xor_Ed_Ib_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        cpu.flagResult = (op1.get32(cpu) ^ immb);
