...
public class rol_Eb_I1_mem extends Executable {
  final Pointer op1;

  public rol_Eb_I1_mem(int blockStart, int eip, int prefices, PeekableInputStream input) {
  ...
  public Branch execute(Processor cpu) {
    ...
    if ((0x1F & 1) > 0) { // FIXME This is always true
      cpu.cf = bit0;
      cpu.of = bit0 ^ bit31;
