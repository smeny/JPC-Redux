...
public class mov_rDXr10_Iw extends Executable
{
    final int immw;

    public mov_rDXr10_Iw(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
