...
public class fnstcw_Mw_mem extends Executable
{
    final Pointer op1;

    public fnstcw_Mw_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set16(cpu, (short)cpu.fpu.getControl());
        return Branch.None;
    }
