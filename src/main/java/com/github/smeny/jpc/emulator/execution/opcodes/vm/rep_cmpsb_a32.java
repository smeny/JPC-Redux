...
public class rep_cmpsb_a32 extends Executable
{
    final int segIndex;

    public rep_cmpsb_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.rep_cmpsb_a32(cpu, seg);
        return Branch.None;
    }
