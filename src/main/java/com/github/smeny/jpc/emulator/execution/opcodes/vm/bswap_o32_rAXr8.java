...
public class bswap_o32_rAXr8 extends Executable
{

    public bswap_o32_rAXr8(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.r_eax.set32(Integer.reverseBytes(cpu.r_eax.get32()));
        return Branch.None;
    }
