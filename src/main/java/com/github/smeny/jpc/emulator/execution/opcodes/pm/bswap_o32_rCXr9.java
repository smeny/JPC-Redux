...
public class bswap_o32_rCXr9 extends Executable
{

    public bswap_o32_rCXr9(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.r_ecx.set32(Integer.reverseBytes(cpu.r_ecx.get32()));
        return Branch.None;
    }
