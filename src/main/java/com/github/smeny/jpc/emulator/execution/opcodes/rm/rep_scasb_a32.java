...
public class rep_scasb_a32 extends Executable
{

    public rep_scasb_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.rep_scasb_a32(cpu);
        return Branch.None;
    }
