...
public class repne_scasd_a16 extends Executable
{

    public repne_scasd_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.repne_scasd_a16(cpu);
        return Branch.None;
    }
