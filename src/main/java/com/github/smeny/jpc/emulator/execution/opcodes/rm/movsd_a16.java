...
public class movsd_a16 extends Executable
{
    final int segIndex;

    public movsd_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.movsd_a16(cpu, seg);
        return Branch.None;
    }
