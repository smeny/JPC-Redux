...
public class str_Ed_mem extends Executable
{
    final Pointer op1;

    public str_Ed_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set32(cpu,  0xffff & cpu.tss.getSelector());
        return Branch.None;
    }
