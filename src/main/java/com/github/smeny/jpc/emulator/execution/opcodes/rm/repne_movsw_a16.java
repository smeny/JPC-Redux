...
public class repne_movsw_a16 extends Executable
{
    final int segIndex;

    public repne_movsw_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.rep_movsw_a16(cpu, seg);
        return Branch.None;
    }
