...
public class fisubr_Mw_mem extends Executable
{
    final Pointer op1;

    public fisubr_Mw_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.setST(0, op1.get16(cpu)-cpu.fpu.ST(0));
        return Branch.None;
    }
