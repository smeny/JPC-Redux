...
public class movzx_Gw_Eb_mem extends Executable
{
    final int op1Index;
    final Pointer op2;

    public movzx_Gw_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
