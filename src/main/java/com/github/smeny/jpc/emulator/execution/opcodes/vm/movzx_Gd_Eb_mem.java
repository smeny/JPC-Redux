...
public class movzx_Gd_Eb_mem extends Executable
{
    final int op1Index;
    final Pointer op2;

    public movzx_Gd_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
