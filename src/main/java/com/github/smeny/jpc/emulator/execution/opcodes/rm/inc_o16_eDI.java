...
public class inc_o16_eDI extends Executable
{

    public inc_o16_eDI(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        cpu.flagOp1 = (short)cpu.r_edi.get16();
        cpu.flagOp2 = 1;
