...
public class repne_scasb_a16 extends Executable
{

    public repne_scasb_a16(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.repne_scasb_a16(cpu);
        return Branch.None;
    }
