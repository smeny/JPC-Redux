...
public class str_Ew_mem extends Executable
{
    final Pointer op1;

    public str_Ew_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set16(cpu, (short)cpu.tss.getSelector());
        return Branch.None;
    }
