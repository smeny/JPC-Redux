...
public class Modrm {
    ...
    private static int[] regIndices =
            new int[]{3, 11, 15, 7, 2, 10, 14, 6, 1, 9, 13, 5, 21, 23, 17, 19, 0, 8, 12, 4, 20, 22, 16, 18};
    ...
    public static boolean isMem(int modrm) {
        // Mod set to 11 = Register addressing mode
    ...
    public static Pointer getPointer(ExecutableParameters parameters, int modrm) {
        return getPointer(parameters.getPrefixes(), modrm, parameters.getInput());
    }
    ...
    static Pointer getPointer16(int prefices, int modrm, PeekableInputStream input) {
        if (modrm < 0x40) {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr16_00(input, prefices);
                case 0x01:
                    return Ptr16_01(input, prefices);
                case 0x02:
                    return Ptr16_02(input, prefices);
                case 0x03:
                    return Ptr16_03(input, prefices);
                case 0x04:
                    return Ptr16_04(input, prefices);
                case 0x05:
                    return Ptr16_05(input, prefices);
                case 0x06:
                    return Ptr16_06(input, prefices);
                case 0x07:
                    return Ptr16_07(input, prefices);
            }
        } else if (modrm < 0x80) {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr16_40(input, prefices);
                case 0x01:
                    return Ptr16_41(input, prefices);
                case 0x02:
                    return Ptr16_42(input, prefices);
                case 0x03:
                    return Ptr16_43(input, prefices);
                case 0x04:
                    return Ptr16_44(input, prefices);
                case 0x05:
                    return Ptr16_45(input, prefices);
                case 0x06:
                    return Ptr16_46(input, prefices);
                case 0x07:
                    return Ptr16_47(input, prefices);
            }
        } else {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr16_80(input, prefices);
                case 0x01:
                    return Ptr16_81(input, prefices);
                case 0x02:
                    return Ptr16_82(input, prefices);
                case 0x03:
                    return Ptr16_83(input, prefices);
                case 0x04:
                    return Ptr16_84(input, prefices);
                case 0x05:
                    return Ptr16_85(input, prefices);
                case 0x06:
                    return Ptr16_86(input, prefices);
                case 0x07:
                    return Ptr16_87(input, prefices);
            }
        }
        return null;
    }
    ...
    private static Pointer Ptr16_00(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.SI_INDEX, 1, 0, Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_01(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.DI_INDEX, 1, 0, Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_02(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.SI_INDEX, 1, 0, Prefices.getSegment(prefices, Processor.SS_INDEX),
                false);
    }

    private static Pointer Ptr16_03(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.DI_INDEX, 1, 0, Prefices.getSegment(prefices, Processor.SS_INDEX),
                false);
    }
    ...
    private static Pointer Ptr16_40(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.SI_INDEX, 1, input.read8(),
                Prefices.getSegment(prefices, Processor.DS_INDEX), false);
    }

    private static Pointer Ptr16_41(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.DI_INDEX, 1, input.read8(),
                Prefices.getSegment(prefices, Processor.DS_INDEX), false);
    }

    private static Pointer Ptr16_42(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.SI_INDEX, 1, input.read8(),
                Prefices.getSegment(prefices, Processor.SS_INDEX), false);
    }

    private static Pointer Ptr16_43(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.DI_INDEX, 1, input.read8(),
                Prefices.getSegment(prefices, Processor.SS_INDEX), false);
    }

    private static Pointer Ptr16_44(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.SI_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_45(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.DI_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_46(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.SS_INDEX),
                false);
    }

    private static Pointer Ptr16_47(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_80(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.SI_INDEX, 1, input.readU16(),
                Prefices.getSegment(prefices, Processor.DS_INDEX), false);
    }

    private static Pointer Ptr16_81(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, Processor.DI_INDEX, 1, input.readU16(),
                Prefices.getSegment(prefices, Processor.DS_INDEX), false);
    }

    private static Pointer Ptr16_82(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.SI_INDEX, 1, input.readU16(),
                Prefices.getSegment(prefices, Processor.SS_INDEX), false);
    }

    private static Pointer Ptr16_83(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, Processor.DI_INDEX, 1, input.readU16(),
                Prefices.getSegment(prefices, Processor.SS_INDEX), false);
    }

    private static Pointer Ptr16_84(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.SI_INDEX, -1, 0, input.readU16(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_85(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.DI_INDEX, -1, 0, input.readU16(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }

    private static Pointer Ptr16_86(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BP_INDEX, -1, 0, input.readU16(), Prefices.getSegment(prefices, Processor.SS_INDEX),
                false);
    }

    private static Pointer Ptr16_87(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.BX_INDEX, -1, 0, input.readU16(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                false);
    }
    ...
    static Pointer getPointer32(int prefices, int modrm, PeekableInputStream input) {
        if (modrm < 0x40) {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr32_00(input, prefices);
                case 0x01:
                    return Ptr32_01(input, prefices);
                case 0x02:
                    return Ptr32_02(input, prefices);
                case 0x03:
                    return Ptr32_03(input, prefices);
                case 0x04:
                    return Ptr32_04(input, prefices);
                case 0x05:
                    return Ptr32_05(input, prefices);
                case 0x06:
                    return Ptr32_06(input, prefices);
                case 0x07:
                    return Ptr32_07(input, prefices);
            }
        } else if (modrm < 0x80) {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr32_40(input, prefices);
                case 0x01:
                    return Ptr32_41(input, prefices);
                case 0x02:
                    return Ptr32_42(input, prefices);
                case 0x03:
                    return Ptr32_43(input, prefices);
                case 0x04:
                    return Ptr32_44(input, prefices);
                case 0x05:
                    return Ptr32_45(input, prefices);
                case 0x06:
                    return Ptr32_46(input, prefices);
                case 0x07:
                    return Ptr32_47(input, prefices);
            }
        } else {
            switch (modrm & 7) {
                case 0x00:
                    return Ptr32_80(input, prefices);
                case 0x01:
                    return Ptr32_81(input, prefices);
                case 0x02:
                    return Ptr32_82(input, prefices);
                case 0x03:
                    return Ptr32_83(input, prefices);
                case 0x04:
                    return Ptr32_84(input, prefices);
                case 0x05:
                    return Ptr32_85(input, prefices);
                case 0x06:
                    return Ptr32_86(input, prefices);
                case 0x07:
                    return Ptr32_87(input, prefices);
            }
        }
        return null;
    }
    ...
    private static Pointer Ptr32_40(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EAX_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_41(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.ECX_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_42(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EDX_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_43(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EBX_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }
    ...
    private static Pointer Ptr32_45(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EBP_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.SS_INDEX),
                true);
    }

    private static Pointer Ptr32_46(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.ESI_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_47(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EDI_INDEX, -1, 0, input.read8(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_80(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EAX_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_81(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.ECX_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_82(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EDX_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_83(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EBX_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }
    ...
    private static Pointer Ptr32_85(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EBP_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.SS_INDEX),
                true);
    }

    private static Pointer Ptr32_86(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.ESI_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }

    private static Pointer Ptr32_87(PeekableInputStream input, int prefices) {
        return new Pointer(Processor.EDI_INDEX, -1, 0, input.read32(), Prefices.getSegment(prefices, Processor.DS_INDEX),
                true);
    }
}
