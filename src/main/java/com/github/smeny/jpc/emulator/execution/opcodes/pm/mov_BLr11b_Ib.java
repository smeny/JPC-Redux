...
public class mov_BLr11b_Ib extends Executable
{
    final int immb;

    public mov_BLr11b_Ib(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
