...
public class adc_Ed_Ib_mem extends Executable {
  final Pointer op1;
  final int immb;

  public adc_Ed_Ib_mem(int blockStart, int eip, int prefices, PeekableInputStream input) {
  ...
  public Branch execute(Processor cpu) {
    boolean incf =
        Processor.getCarryFlag(cpu.flagStatus, cpu.cf, cpu.flagOp1, cpu.flagOp2, cpu.flagResult, cpu.flagIns);
