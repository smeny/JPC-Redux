...
public class push_o16_rSPr12 extends Executable
{

    public push_o16_rSPr12(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.push16((short)cpu.r_esp.get16());
        return Branch.None;
    }
