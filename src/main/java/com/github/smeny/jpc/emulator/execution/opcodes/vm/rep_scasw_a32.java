...
public class rep_scasw_a32 extends Executable
{

    public rep_scasw_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.repe_scasw_a32(cpu);
        return Branch.None;
    }
