...
public class sidt_o32_M_mem extends Executable
{
    final Pointer op1;

    public sidt_o32_M_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        op1.set32(cpu, 2, cpu.idtr.getBase());
        return Branch.None;
    }
