...
public class sldt_Ew extends Executable
{
    final int op1Index;

    public sldt_Ew(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        op1.set16((short)cpu.ldtr.getSelector());
        return Branch.None;
    }
