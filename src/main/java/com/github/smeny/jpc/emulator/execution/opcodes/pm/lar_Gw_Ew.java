...
public class lar_Gw_Ew extends Executable
{
    final int op1Index;
    final int op2Index;

    public lar_Gw_Ew(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        op1.set16(StaticOpcodes.lar(cpu, op2.get16(), op1.get16()));
        return Branch.None;
    }
