...
public class rep_cmpsd_a32 extends Executable
{
    final int segIndex;

    public rep_cmpsd_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.rep_cmpsd_a32(cpu, seg);
        return Branch.None;
    }
