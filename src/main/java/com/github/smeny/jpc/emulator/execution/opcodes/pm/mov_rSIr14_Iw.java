...
public class mov_rSIr14_Iw extends Executable
{
    final int immw;

    public mov_rSIr14_Iw(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
