...
public class fild_Md_mem extends Executable
{
    final Pointer op1;

    public fild_Md_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.push((double)op1.get32(cpu));
        return Branch.None;
    }
