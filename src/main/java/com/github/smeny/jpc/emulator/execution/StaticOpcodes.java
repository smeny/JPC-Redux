...
import com.github.smeny.jpc.emulator.processor.ProtectedModeSegment;
import com.github.smeny.jpc.emulator.processor.Segment;

import static com.github.smeny.jpc.emulator.execution.Executable.OSZAPC;
import static com.github.smeny.jpc.emulator.execution.Executable.OSZP;
import static com.github.smeny.jpc.emulator.execution.Executable.SZP;
...
public class StaticOpcodes {
  ...
  public static int lar(Processor cpu, int selector, int original) {
    ...
    final boolean valid[] =
        {false, true, true, true, true, true, false, false, false, true, false, true, true, false, false, false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true};
