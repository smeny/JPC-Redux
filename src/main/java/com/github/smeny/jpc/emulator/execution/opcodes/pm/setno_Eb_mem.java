...
public class setno_Eb_mem extends Executable
{
    final Pointer op1;

    public setno_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
