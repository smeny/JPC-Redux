...
public class setae_Eb_mem extends Executable
{
    final Pointer op1;

    public setae_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
