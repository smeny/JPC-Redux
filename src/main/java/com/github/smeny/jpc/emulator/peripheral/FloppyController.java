...
import com.github.smeny.jpc.j2se.*;
...
public class FloppyController implements IODevice, DMATransferCapable, HardwareComponent, TimerResponsive
{
    ...
    public void changeDisk(com.github.smeny.jpc.support.BlockDevice disk, int i)
    {
    ...
    static class FloppyDrive implements Hibernatable
    {
        ...
        private void changeDisk(com.github.smeny.jpc.support.BlockDevice disk)
        {
            device = disk;
            revalidate();
        }
