...
import com.github.smeny.jpc.emulator.execution.codeblock.*;
import com.github.smeny.jpc.emulator.processor.Processor;
import com.github.smeny.jpc.j2se.Option;

/**
 * <code>Memory</code> object with simple execute capabilities.  Uses a {@link com.github.smeny.jpc.emulator.execution.codeblock.CodeBlockManager}
 * instance to generate {@link com.github.smeny.jpc.emulator.execution.codeblock.CodeBlock} objects which are then stored in mirror
...
public class LazyCodeBlockMemory extends AbstractMemory {
  ...
  public void copyContentsIntoArray(int address, byte[] buf, int off, int len) {
    try {
      ...
      System.out.println(
          "Array bounds exception reading from lazycodeblockmemory: address=0x" + Integer.toHexString(address) +
