...
public class repne_scasd_a32 extends Executable
{

    public repne_scasd_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.repne_scasd_a32(cpu);
        return Branch.None;
    }
