...
public class fild_Mw_mem extends Executable
{
    final Pointer op1;

    public fild_Mw_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.push((double)op1.get16(cpu));
        return Branch.None;
    }
