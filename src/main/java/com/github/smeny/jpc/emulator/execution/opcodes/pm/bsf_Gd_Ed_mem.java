...
public class bsf_Gd_Ed_mem extends Executable
{
    final int op1Index;
    final Pointer op2;

    public bsf_Gd_Ed_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
	    ...
	    cpu.zf(false);
            ...
            cpu.flagStatus = SP;
            cpu.flagResult = StaticOpcodes.numberOfTrailingZeros(op2.get32(cpu));
