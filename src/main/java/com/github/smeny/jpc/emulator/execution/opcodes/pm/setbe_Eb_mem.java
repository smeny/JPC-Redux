...
public class setbe_Eb_mem extends Executable
{
    final Pointer op1;

    public setbe_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set8(cpu, (byte)(cpu.cf() || cpu.zf() ? 1 : 0));
        return Branch.None;
    }
