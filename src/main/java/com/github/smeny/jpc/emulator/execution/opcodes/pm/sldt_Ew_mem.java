...
public class sldt_Ew_mem extends Executable
{
    final Pointer op1;

    public sldt_Ew_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        op1.set16(cpu, (short)cpu.ldtr.getSelector());
        return Branch.None;
    }
