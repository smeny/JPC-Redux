...
public class repne_cmpsw_a32 extends Executable
{
    final int segIndex;

    public repne_cmpsw_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        StaticOpcodes.repne_cmpsw_a32(cpu, seg);
        return Branch.None;
    }
