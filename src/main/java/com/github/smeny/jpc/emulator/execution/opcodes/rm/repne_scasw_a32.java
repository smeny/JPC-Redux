...
public class repne_scasw_a32 extends Executable
{

    public repne_scasw_a32(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        StaticOpcodes.repne_scasw_a32(cpu);
        return Branch.None;
    }
