...
public class setns_Eb_mem extends Executable
{
    final Pointer op1;

    public setns_Eb_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
