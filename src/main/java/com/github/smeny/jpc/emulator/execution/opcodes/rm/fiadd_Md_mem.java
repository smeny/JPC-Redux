...
public class fiadd_Md_mem extends Executable
{
    final Pointer op1;

    public fiadd_Md_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    {
        cpu.fpu.setST(0, cpu.fpu.ST(0)+op1.get32(cpu));
        return Branch.None;
    }
