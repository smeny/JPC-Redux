...
public class and_Ew_Ib_mem extends Executable
{
    final Pointer op1;
    final int immb;

    public and_Ew_Ib_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        cpu.flagResult = (short)(op1.get16(cpu) & immb);
