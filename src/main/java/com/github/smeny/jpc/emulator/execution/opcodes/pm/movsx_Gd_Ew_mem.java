...
public class movsx_Gd_Ew_mem extends Executable
{
    final int op1Index;
    final Pointer op2;

    public movsx_Gd_Ew_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
