...
public class loopne_a32_Jb extends Executable
{
    final int jmp;
    final int blockLength;
    final int instructionLength;

    public loopne_a32_Jb(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
